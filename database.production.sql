DROP DATABASE IF EXISTS `InternetBanking_production`;
CREATE DATABASE `InternetBanking_production` /*!40100 COLLATE 'utf8mb4_0900_ai_ci' */;
USE `InternetBanking_production`;
